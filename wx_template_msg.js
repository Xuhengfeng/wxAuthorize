...
const config = {
  ...
  appid: 'wx91e9f36911f1c6d6', //对应测试号信息里的appID
  secret: '52f517b3a00a3136b0c399027e3ea886', //对应测试号信息里的appsecret
...
app.get('/authentication', function(req, res) {
  ...
  const redirect_uri = urlencode('http://24j908r142.wicp.vip/code'); //这里的url需要转为加密格式，它的作用是访问微信网页鉴权接口成功后微信会回调这个地址，并把code参数带在回调地址中
...
function sendTemplateMsg(openid, access_token) {
  ...
  const requestData = {
    //发送模板消息的数据
    touser: openid,
    template_id: 'n24jmvf-vJi5Ufq_WRjVScTMMr2rJFur_GBdUT3eN-E',
